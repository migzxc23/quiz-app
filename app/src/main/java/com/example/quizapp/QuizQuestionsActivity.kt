...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // TODO: creating global variable so that it can be accessible to the entire class
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: getting the questions to Constants getQuestions function
    ...
    private fun setQuestion() {
        ...
        tvProgress?.text =
            "$mCurrentPosition / ${progressBar?.max}" // displaying progress bar count
...
//                            Toast.makeText(this, "Congrats", Toast.LENGTH_LONG).show()
    ...
    // option color if answered correct or wrong
